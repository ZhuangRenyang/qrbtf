        ...
        <div className="Qr-titled-nobg">
            ...
            <div className="title-margin">
                <div className="Qr-article">
                    ...
                    <div className="Qr-Centered">
                        ...
                        <h2>使用遇到了问题，怎么反馈？</h2>
                        <p>可能在设计与开发的过程中有一些疏漏，敬请谅解。如果遇到浏览器兼容问题，请暂时选择更换软件或设备尝试。</p>
                        <p>编写二维码样式是一个锻炼设计与开发（JavaScript）能力的绝佳机会，如果你有兴趣和我们一起玩这个项目，欢迎添加我的微信（微信号：<span
                            style={{userSelect: "text"}}>ovozcn</span>，请备注真实姓名）或发送邮件至 <LinkTrace
                            href='mailto:zryse@qq.com'>contact@qrbtf.com</LinkTrace> 联系我们！</p>
            ...
            <div className="Qr-Centered btn-row">
                <div className="div-btn">
                    <LinkButton href={"https://illlli.com/personal/about"} value={"打赏"}/>
                    <LinkButton href={"https://github.com/ZhuangRenyang"} value={"Github"}/>
                </div>
                <div className="div-btn">
                    <LinkButton href={"https://illlli.com/comments"} value={"反馈"}/>
                    <LinkButton href={"https://github.com/ZhuangRenyang"} value={"开发"}/>
                </div>
            </div>
        </div>
    )
